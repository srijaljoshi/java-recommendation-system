...
<ul class="list-group category_block">
    <li class="list-group-item"><a href="category.html">LAPTOPS</a></li>
<li class="list-group-item"><a href="category.html">PHONES</a></li>
<li class="list-group-item"><a href="category.html">SHOES</a></li>
</ul>
</div>
<div class="card bg-light mb-3">
