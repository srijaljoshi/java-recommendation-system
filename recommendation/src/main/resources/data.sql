...
--insert into recommendation.products (id, name, description, image_url, price, product_brand_id, product_category_id) values (34,'SONOLINE B - BABY HEARTBEAT TRACKER', 'Sale Ends April 23, 2020. Limited Time Offer: Free 60ml Sample Soun. Enhancing Gel + LifeForce® Batteries','https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcROa1FTTO747w310NgZ27rFOXQerMuOqU0zkGLOxluZE9oOXJEEv-jJyy_czWP_1yOCBWqjxfWh2NA&usqp=CAc', '59.95', 42,27);
--insert into recommendation.products (id, name, description, image_url, price, product_brand_id, product_category_id) values (34,
...
insert into recommendation.demo_user(user_id, product_id, rating) values (2,5,3);
insert into recommendation.demo_user(user_id, product_id, rating) values (3,9,4);
insert into recommendation.demo_user(user_id, product_id, rating) values (1,19,3);
